...
export declare const ActivitySchema: Schema<IActivity, import("mongoose").Model<IActivity, any, any, any, import("mongoose").Document<unknown, any, IActivity> & import("@actunime/types/_activityType").IActivityRoot & {
    id: string;
} & {
